...
let CustomerList = () => {
    let [customers , setCustomers] = useState(customerList);
    return(
        <React.Fragment>
                        ...
                        <table className="table table-hover text-center table-striped table-success">
                            ...
                            <tbody>
                            {
                                customers.map((customer) => {
                                    return (
                                        <tr>
                                            <td>{customer.login.uuid.length-4}</td>
                                            <td>
                                                <img src={customer.picture.large} width="70" height="70" className="img-thumbnail " alt=""/>
                                            </td>
